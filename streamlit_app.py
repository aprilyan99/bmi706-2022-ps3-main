...
year = st.slider("Year", min_value = int(df['Year'].min()), max_value = int(df['Year'].max()), step=1)
...
countries = st.multiselect("Countries", options=df['Country'].unique(), default=countries)
